...
window.onload =function(){
    rightBtn.style.display=tabMenu.scrollWidth > tabMenu.clientWidth ||tabMenu.scrollWidth >= window.innerWidth ? "block" : "none";
    leftBtn.style.display=tabMenu.scrollWidth >= window.innerWidth ? "display" :"none";
}
...
if (!activeDrag) return;
 ...
 tabMenu.addEventListener("mousemove",() => {
    activeDrag =true;
 });
